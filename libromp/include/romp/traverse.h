 ...
 */
class ROMP_API_WITH_RTTI BaseTraversal {
...
class ROMP_API_WITH_RTTI Traversal : public BaseTraversal {
...
class ROMP_API_WITH_RTTI ConstBaseTraversal {
...
class ROMP_API_WITH_RTTI ConstTraversal : public ConstBaseTraversal {
 ...
 * node.
 */
class ROMP_API_WITH_RTTI ConstExprTraversal : public ConstBaseTraversal {
 ...
 * node.
 */
class ROMP_API_WITH_RTTI ConstStmtTraversal : public ConstBaseTraversal {
...
class ROMP_API_WITH_RTTI ConstTypeTraversal : public ConstBaseTraversal {
