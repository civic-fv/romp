 ...
 */
class MURPHI_API_WITH_RTTI BaseTraversal {
...
public:
  ...
  // added syntax nodes
  virtual void visit_chooserule(ChooseRule& n) = 0;
...
class MURPHI_API_WITH_RTTI Traversal : public BaseTraversal {
...
class MURPHI_API_WITH_RTTI ConstBaseTraversal {
...
class MURPHI_API_WITH_RTTI ConstTraversal : public ConstBaseTraversal {
 ...
 * node.
 */
class MURPHI_API_WITH_RTTI ConstExprTraversal : public ConstBaseTraversal {
 ...
 * node.
 */
class MURPHI_API_WITH_RTTI ConstStmtTraversal : public ConstBaseTraversal {
...
class MURPHI_API_WITH_RTTI ConstTypeTraversal : public ConstBaseTraversal {
