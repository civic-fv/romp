...
#define RULE_TAKEN_LIMIT 3
#define PACK_STATE 1
#define SCHEDULE_BITS 0ul
...
static const value_t ru_N __attribute__((unused)) = VALUE_C(5);

static bool ru_IncrementMod(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused)), struct handle ru_v, struct handle ru_m) {
  const struct handle ru_i __attribute__((unused)) = state_handle(s, 15ull, 3ull);
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  {
  if (handle_read("sort5.m:47.5: ", rule_name, "v", s, VALUE_C(0), VALUE_C(4), ru_v) == handle_read("sort5.m:47.9: ", rule_name, "m", s, VALUE_C(0), VALUE_C(4), ru_m)) {
handle_write("sort5.m:48.3-8: ", rule_name, "v", s, VALUE_C(0), VALUE_C(4), ru_v, VALUE_C(0));
}
else  {
handle_write("sort5.m:50.5-14: ", rule_name, "v", s, VALUE_C(0), VALUE_C(4), ru_v, add("sort5.m:50.10-14: ", rule_name, "(v + 1)", s, handle_read("sort5.m:50.10: ", rule_name, "v", s, VALUE_C(0), VALUE_C(4), ru_v), VALUE_C(1)));
}
;
...
static bool ru_Increment(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused)), struct handle ru_v) {
  const struct handle ru_i __attribute__((unused)) = state_handle(s, 15ull, 3ull);
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  {
  ({ uint8_t v50_1_[BITS_TO_BYTES(3)] = { 0 }; struct handle v50_1 = { .base = v50_1_, .offset = 0, .width = 3ull }; handle_write("sort5.m:56.2-23: ", rule_name, "<temporary>", s, VALUE_C(0), VALUE_C(4), v50_1, sub("sort5.m:56.19-21: ", rule_name, "(N - 1)", s, VALUE_C(5), VALUE_C(1))); ru_IncrementMod(rule_name, state_drop_const(s), ru_v, v50_1); });
  return true; /* ignored by caller */
  }
}

static bool ru_Swap(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused)), struct handle ru_a) {
  const struct handle ru_i __attribute__((unused)) = state_handle(s, 15ull, 3ull);
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  {
  uint8_t _ru_tmp[BITS_TO_BYTES(3)] = { 0 };
  const struct handle ru_tmp __attribute__((unused)) = { .base = _ru_tmp, .offset = 0ul, .width = 3ull };
  handle_write("sort5.m:62.2-12: ", rule_name, "tmp", s, VALUE_C(0), VALUE_C(4), ru_tmp, handle_read("sort5.m:62.9-12: ", rule_name, "a[i]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:62.9-12: ", rule_name, "a[i]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:62.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(4), ru_i))));
  handle_write("sort5.m:63.2-13: ", rule_name, "a[i]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:63.2-5: ", rule_name, "a[i]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:63.4: ", rule_name, "i", s, VALUE_C(0), VALUE_C(4), ru_i)), handle_read("sort5.m:63.10-13: ", rule_name, "a[j]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:63.10-13: ", rule_name, "a[j]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:63.12: ", rule_name, "j", s, VALUE_C(0), VALUE_C(4), ru_j))));
  handle_write("sort5.m:64.2-12: ", rule_name, "a[j]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:64.2-5: ", rule_name, "a[j]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:64.4: ", rule_name, "j", s, VALUE_C(0), VALUE_C(4), ru_j)), handle_read("sort5.m:64.10-12: ", rule_name, "tmp", s, VALUE_C(0), VALUE_C(4), ru_tmp));
  handle_write("sort5.m:65.2-9: ", rule_name, "tmp", s, VALUE_C(0), VALUE_C(4), ru_tmp, VALUE_C(0));
  return true; /* ignored by caller */
  }
}

static int guard0(const struct state *NONNULL s __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"i\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  return VALUE_C(1) ? 1 : 0;

}

static bool rule0(struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "rule \"i\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  {
  ({ uint8_t v83_1_[BITS_TO_BYTES(3)] = { 0 }; struct handle v83_1 = { .base = v83_1_, .offset = 0, .width = 3ull }; handle_write("sort5.m:73.2-23: ", rule_name, "<temporary>", s, VALUE_C(0), VALUE_C(4), v83_1, sub("sort5.m:73.19-21: ", rule_name, "(N - 1)", s, VALUE_C(5), VALUE_C(1))); ru_IncrementMod(rule_name, state_drop_const(s), ru_i, v83_1); });
  }

  return true;
}

static int guard1(const struct state *NONNULL s __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"j\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
...
static bool rule1(struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "rule \"j\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
  ...
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  {
  ({ ru_Increment(rule_name, state_drop_const(s), ru_j); });
  }

  return true;
}

static int guard2(const struct state *NONNULL s __attribute__((unused))) {
  static const char *rule_name __attribute__((unused)) = "guard of rule \"swap\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* this guard triggered an error */
      return -1;
  ...
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  return ((handle_read("sort5.m:84.2: ", rule_name, "i", s, VALUE_C(0), VALUE_C(4), ru_i) < handle_read("sort5.m:84.6: ", rule_name, "j", s, VALUE_C(0), VALUE_C(4), ru_j)) && (handle_read("sort5.m:84.12-15: ", rule_name, "a[i]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:84.12-15: ", rule_name, "a[i]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:84.14: ", rule_name, "i", s, VALUE_C(0), VALUE_C(4), ru_i))) > handle_read("sort5.m:84.19-22: ", rule_name, "a[j]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:84.19-22: ", rule_name, "a[j]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:84.21: ", rule_name, "j", s, VALUE_C(0), VALUE_C(4), ru_j))))) ? 1 : 0;

}

static bool rule2(struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "rule \"swap\"";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
      /* an error was triggered during this rule */
      return false;
  ...
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
  {
  ({ ru_Swap(rule_name, state_drop_const(s), ru_a); });
  }
...
static bool startstate0(struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "startstate 1";
  if (JMP_BUF_NEEDED) {
    if (sigsetjmp(checkpoint, 0)) {
  ...
  {
    do {
  struct handle root = ru_i;
  handle_write_raw(s, (struct handle){ .base = root.base + (root.offset + ((size_t)0)) / CHAR_BIT, .offset = (root.offset + ((size_t)0)) % CHAR_BIT, .width = 3ull }, 1);
} while (0);
    do {
  struct handle root = ru_j;
  handle_write_raw(s, (struct handle){ .base = root.base + (root.offset + ((size_t)0)) / CHAR_BIT, .offset = (root.offset + ((size_t)0)) % CHAR_BIT, .width = 3ull }, 1);
} while (0);
    {
  ...
  #pragma GCC diagnostic pop
#endif
  for (raw_value_t _ru1_f = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))); _ru1_f == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))) || (lb < ub && ((value_t)(_ru1_f - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) <= ub) || (lb > ub && ((value_t)(_ru1_f - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) >= ub); _ru1_f += step) {
    uint8_t _ru2_f[BITS_TO_BYTES(((size_t)3ull))] = { 0 };
    struct handle ru_f = { .base = _ru2_f, .offset = 0, .width = ((size_t)3ull) };
    handle_write_raw(s, ru_f, _ru1_f);
  handle_write("sort5.m:96.3-19: ", rule_name, "a[f]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:96.3-8: ", rule_name, "a[f]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:96.6: ", rule_name, "f", s, VALUE_C(0), VALUE_C(4), ru_f)), sub("sort5.m:96.13-19: ", rule_name, "((N - 1) - f)", s, sub("sort5.m:96.13-15: ", rule_name, "(N - 1)", s, VALUE_C(5), VALUE_C(1)), handle_read("sort5.m:96.19: ", rule_name, "f", s, VALUE_C(0), VALUE_C(4), ru_f)));
     ...
     */
    {
      ...
      if (ub >= lb && (value_t)step > 0 && ((value_t)(max_ - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) < ub && _ru1_f > RAW_VALUE_MAX - step) {
        break;
      }
    }
#ifdef __clang__
  ...
  #pragma GCC diagnostic ignored "-Wsign-compare"
#endif
    {
      ...
      if (ub <= lb && (value_t)step < 0 && ((value_t)(min_ - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) > ub && ((value_t)(_ru1_f - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) < ((value_t)(RAW_VALUE_MIN - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(0))))) {
#ifdef __clang__
  #pragma clang diagnostic pop
#elif defined(__GNUC__)
  #pragma GCC diagnostic pop
...
static __attribute__((unused)) bool property0(const struct state *NONNULL s) {
  static const char *rule_name __attribute__((unused)) = "property 1";
  const struct handle ru_i __attribute__((unused)) = state_handle(s, 15ull, 3ull);
  const struct handle ru_j __attribute__((unused)) = state_handle(s, 18ull, 3ull);
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
...
if ((handle_read("sort5.m:101.23-26: ", rule_name, "a[i]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:101.23-26: ", rule_name, "a[i]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, handle_read("sort5.m:101.25: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) > handle_read("sort5.m:101.30-35: ", rule_name, "a[(i + 1)]", s, VALUE_C(0), VALUE_C(4), handle_index("sort5.m:101.30-35: ", rule_name, "a[(i + 1)]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_a, add("sort5.m:101.32-34: ", rule_name, "(i + 1)", s, handle_read("sort5.m:101.32: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i), VALUE_C(1)))))) { result = true; break; }    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
    {
...
static void state_print(const struct state *previous, const struct state *NONNULL s) {
  ...
  const struct handle ru_a __attribute__((unused)) = state_handle(s, 0ull, 15ull);
{
  raw_value_t v = handle_read_raw(s, ru_i);
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = (uint8_t*)previous->data + (ru_i.base - (const uint8_t*)s->data), .offset = ru_i.offset, .width = ru_i.width }));
  }
...
{
  raw_value_t v = handle_read_raw(s, ru_j);
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = (uint8_t*)previous->data + (ru_j.base - (const uint8_t*)s->data), .offset = ru_j.offset, .width = ru_j.width }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
...
{
  raw_value_t v = handle_read_raw(s, ((struct handle){ .base = ru_a.base + (ru_a.offset + (i0 * ((size_t)3ull))) / CHAR_BIT, .offset = (ru_a.offset + (i0 * ((size_t)3ull))) % CHAR_BIT, .width = 3ull }));
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_a.base - (const uint8_t*)s->data), .offset = ru_a.offset, .width = ru_a.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_a.base - (const uint8_t*)s->data), .offset = ru_a.offset, .width = ru_a.width }).offset + (i0 * ((size_t)3ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_a.base - (const uint8_t*)s->data), .offset = ru_a.offset, .width = ru_a.width }).offset + (i0 * ((size_t)3ull))) % CHAR_BIT, .width = 3ull }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("a"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put("\" value=\"");
    } else {
      do { put("a"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put(":");
...
static void state_print_field_offsets(void) {
  ...
  put("-byte aligned\n");
  put("	* field i is located at state offset 15 bits\n");
  put("	* field j is located at state offset 18 bits\n");
  put("	* field a is located at state offset 0 bits\n");
  put("\n");
}
