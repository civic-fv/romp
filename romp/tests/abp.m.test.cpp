...
#define __model__filepath "/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m"


#define __model__filepath_contains_space (true)


#define __model__filename "abp.m"
...
namespace __type__ {
  ...
  std::string to_string(const PacketType val) { switch (val) { case EMPTY: return "EMPTY"; case PACKET: return "PACKET"; case ACK: return "ACK"; case CORRUPT: return "CORRUPT"; default: break; } return "PacketType::__UNKNOWN_ENUM_VALUE__"; }
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& PacketType_to_json(::romp::ojstream<O>& json, const PacketType& val) noexcept { json << '"' << to_string(val) << '"'; return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& PacketType_to_json(::romp::ojstream<O>& json, const PacketType& val) noexcept { json << "{\"$type\":\"enum-value\",\"type\":\"PacketType\",\"value\":\"" << to_string(val) <<"\"}"; return ::romp::S_VOID; }
#endif
  const ::romp::stream_void& PacketType_to_str(::romp::ostream_p& out, const PacketType& val) noexcept { out << to_string(val); return ::romp::S_VOID; }

  typedef range_t ValueType;
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& ValueType_to_json(::romp::ojstream<O>& json, const ValueType& val) noexcept { json << val; return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& ValueType_to_json(::romp::ojstream<O>& json, const ValueType& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"ValueType\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(1)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& ValueType_to_str(::romp::ostream_p& out, const ValueType& val) noexcept { out << ((range_t)val); return ::romp::S_VOID;}
...
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& PacketRecord_to_json(::romp::ojstream<O>& json, const PacketRecord& val) noexcept { using namespace ::__type__; json  << PacketType_to_json(json,val.Status) << ',' << ValueType_to_json(json,val.Value) << ',' << ValueType_to_json(json,val.SeqNo); return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& PacketRecord_to_json(::romp::ojstream<O>& json, const PacketRecord& val) noexcept { using namespace ::__type__; json << "{\"$type\":\"record-value\",\"type\":\"PacketRecord\",\"fields\":[" << "{\"$type\":\"kv-pair\",\"key\":\"Status\",\"value\":" << PacketType_to_json(json,val.Status) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"Value\",\"value\":" << ValueType_to_json(json,val.Value) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"SeqNo\",\"value\":" << ValueType_to_json(json,val.SeqNo)<< "}]}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& PacketRecord_to_str(::romp::ostream_p& out, const PacketRecord& val) noexcept { using namespace ::__type__; out << "{\n" << out.indent() << out.indentation() << "Status " << ((::romp::OPTIONS.result_show_type) ? ": PacketType =" : ":=") << ' ' << PacketType_to_str(out,val.Status) << '\n' << out.indentation() << "Value " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.Value) << '\n' << out.indentation() << "SeqNo " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.SeqNo) << '\n' << out.dedent()<< out.indentation() << '}'; return ::romp::S_VOID;}
...
#else
  template<class O> const ::romp::stream_void& anon0x0_t_to_json(::romp::ojstream<O>& json, const anon0x0_t& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"0..1\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(1)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
...
#ifdef __ROMP__SIMPLE_TRACE
template<class O> const ::romp::stream_void& __Model___to_json(::romp::ojstream<O>& json, const __Model__& val) noexcept { using namespace ::__type__; json  << PacketRecord_to_json(json,val.X2RChannel) << ',' << PacketRecord_to_json(json,val.R2XChannel) << ',' << ValueType_to_json(json,val.Value) << ',' << ValueType_to_json(json,val.OldValue) << ',' << anon0x0_t_to_json(json,val.SentOne) << ',' << ValueType_to_json(json,val.ReceivedValue) << ',' << ValueType_to_json(json,val.XSeqNo) << ',' << ValueType_to_json(json,val.RSeqNo); return ::romp::S_VOID; }
#else
template<class O> const ::romp::stream_void& __Model___to_json(::romp::ojstream<O>& json, const __Model__& val) noexcept { using namespace ::__type__; json << "{\"$type\":\"record-value\",\"type\":\"__Model__\",\"fields\":[" << "{\"$type\":\"kv-pair\",\"key\":\"X2RChannel\",\"value\":" << PacketRecord_to_json(json,val.X2RChannel) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"R2XChannel\",\"value\":" << PacketRecord_to_json(json,val.R2XChannel) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"Value\",\"value\":" << ValueType_to_json(json,val.Value) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"OldValue\",\"value\":" << ValueType_to_json(json,val.OldValue) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"SentOne\",\"value\":" << anon0x0_t_to_json(json,val.SentOne) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"ReceivedValue\",\"value\":" << ValueType_to_json(json,val.ReceivedValue) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"XSeqNo\",\"value\":" << ValueType_to_json(json,val.XSeqNo) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"RSeqNo\",\"value\":" << ValueType_to_json(json,val.RSeqNo)<< "}]}"; return ::romp::S_VOID;}
#endif
const ::romp::stream_void& __Model___to_str(::romp::ostream_p& out, const __Model__& val) noexcept { using namespace ::__type__; out << "{\n" << out.indent() << out.indentation() << "X2RChannel " << ((::romp::OPTIONS.result_show_type) ? ": PacketRecord =" : ":=") << ' ' << PacketRecord_to_str(out,val.X2RChannel) << '\n' << out.indentation() << "R2XChannel " << ((::romp::OPTIONS.result_show_type) ? ": PacketRecord =" : ":=") << ' ' << PacketRecord_to_str(out,val.R2XChannel) << '\n' << out.indentation() << "Value " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.Value) << '\n' << out.indentation() << "OldValue " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.OldValue) << '\n' << out.indentation() << "SentOne " << ((::romp::OPTIONS.result_show_type) ? ": 0..1 =" : ":=") << ' ' << anon0x0_t_to_str(out,val.SentOne) << '\n' << out.indentation() << "ReceivedValue " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.ReceivedValue) << '\n' << out.indentation() << "XSeqNo " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.XSeqNo) << '\n' << out.indentation() << "RSeqNo " << ((::romp::OPTIONS.result_show_type) ? ": ValueType =" : ":=") << ' ' << ValueType_to_str(out,val.RSeqNo) << '\n' << out.dedent()<< out.indentation() << '}'; return ::romp::S_VOID;}
}
namespace romp {
#ifdef __ROMP__SIMPLE_TRACE
...
#define _ROMP_STATESPACE_COUNT_str "1476225"
...
#define _ROMP_FUNCTS_LEN (1ul)
  ...
  const ::romp::FunctInfo FUNCT_INFOS[_ROMP_FUNCTS_LEN] = {{"SendPacket",{{51,1},{57,5}},"{\"$type\":\"procedure\",\"label\":\"SendPacket\",\"params\":[{\"$type\":\"param\",\"id\":\"Channel\",\"type\":\"PacketRecord\"},{\"$type\":\"param\",\"id\":\"Status\",\"type\":\"PacketType\"},{\"$type\":\"param\",\"id\":\"Value\",\"type\":\"ValueType\"},{\"$type\":\"param\",\"id\":\"SeqNo\",\"type\":\"ValueType\"}],\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[51,1],\"end\":[57,5]}}","procedure SendPacket(Channel: PacketRecord; var Status: PacketType; var Value,SeqNo: ValueType);"},};
...
#define _ROMP_ERRORS_LEN (3ul)
  ...
  const ::romp::MErrorInfo ERROR_INFOS[_ROMP_ERRORS_LEN] = {{"Invalid Packet Type received at the Transmitter\\n",{{102,7},{102,64}},0,"{\"$type\":\"error-statement\",\"label\":\"Invalid Packet Type received at the Transmitter\\\\n\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[102,7],\"end\":[102,64]}"},{"Receiver has received 2 packets with value 1\\n",{{125,11},{125,65}},0,"{\"$type\":\"error-statement\",\"label\":\"Receiver has received 2 packets with value 1\\\\n\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[125,11],\"end\":[125,65]}"},{"Invalid Packet Type received at the Receiver\\n",{{135,7},{135,61}},0,"{\"$type\":\"error-statement\",\"label\":\"Invalid Packet Type received at the Receiver\\\\n\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[135,7],\"end\":[135,61]}"},};
...
#define _ROMP_STARTSTATE_INFO_LEN (1ul)
  ...
  const ::romp::StartStateInfo STARTSTATE_INFOS[_ROMP_STARTSTATE_INFO_LEN] = {{"startstate0",{{160,1},{173,4}},"{\"$type\":\"startstate\",\"label\":\"startstate0\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[160,1],\"end\":[173,4]}"},};
...
#define _ROMP_RULESETS_LEN (6ul)
  ...
  const ::romp::RuleInfo RULE_SET_INFOS[_ROMP_RULESETS_LEN] = {{"Generate_Value_0_to_send",{{59,1},{64,4}},"{\"$type\":\"rule\",\"expr\":\"(R2XChannel.Status != EMPTY)\",\"label\":\"Generate_Value_0_to_send\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[59,1],\"end\":[64,4]}"},{"Generate_Value_1_to_send",{{66,1},{71,4}},"{\"$type\":\"rule\",\"expr\":\"((R2XChannel.Status != EMPTY) & (SentOne = 0))\",\"label\":\"Generate_Value_1_to_send\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[66,1],\"end\":[71,4]}"},{"Transmitter",{{73,1},{105,4}},"{\"$type\":\"rule\",\"expr\":\"(R2XChannel.Status != EMPTY)\",\"label\":\"Transmitter\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[73,1],\"end\":[105,4]}"},{"Receiver",{{107,1},{138,4}},"{\"$type\":\"rule\",\"expr\":\"(X2RChannel.Status != EMPTY)\",\"label\":\"Receiver\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[107,1],\"end\":[138,4]}"},{"Corrupt_X2RChannel",{{144,1},{150,4}},"{\"$type\":\"rule\",\"expr\":\"((X2RChannel.Status != EMPTY) & (X2RChannel.Status != CORRUPT))\",\"label\":\"Corrupt_X2RChannel\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[144,1],\"end\":[150,4]}"},{"Corrupt_R2XChannel",{{152,1},{158,4}},"{\"$type\":\"rule\",\"expr\":\"((R2XChannel.Status != EMPTY) & (R2XChannel.Status != CORRUPT))\",\"label\":\"Corrupt_R2XChannel\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/abp.m\",\"start\":[152,1],\"end\":[158,4]}"},};
