/*
	Generated code for a romp "parallel random walker" verification tool based off of the Murphi Model described in:
		Original Murphi Model: arbiter.m
...
#define __model__filepath "/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m"


#define __model__filepath_contains_space (true)


#define __model__filename "arbiter.m"
...
namespace __type__ {
  ...
  typedef range_t anon0x0_t;
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& anon0x0_t_to_json(::romp::ojstream<O>& json, const anon0x0_t& val) noexcept { json << val; return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& anon0x0_t_to_json(::romp::ojstream<O>& json, const anon0x0_t& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"0..(n - 1)\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(3)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& anon0x0_t_to_str(::romp::ostream_p& out, const anon0x0_t& val) noexcept { out << ((range_t)val); return ::romp::S_VOID;}

  typedef struct { ::__type__::boolean data[4]; constexpr const size_t size() const {return (4ul);} } reg;
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& reg_to_json(::romp::ojstream<O>& json, const reg& val) noexcept {std::string sep; for (size_t i=(0ul); i<val.size(); ++i) { json << sep << boolean_to_json(json,val.data[i]); sep = ","; } return ::romp::S_VOID;}
#else
  template<class O> const ::romp::stream_void& reg_to_json(::romp::ojstream<O>& json, const reg& val) noexcept {json << "{\"$type\":\"array-value\",\"type\":\"reg\",\"size\":" << val.size() << ",\"lower-bound\":" << VALUE_C(0) << ",\"upper-bound\":" << VALUE_C(3) << ",\"elements\":["; std::string sep; for (size_t i=(0ul); i<val.size(); ++i) { json << sep << boolean_to_json(json,val.data[i]); sep = ","; } json << "]}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& reg_to_str(::romp::ostream_p& out, const reg& val) noexcept { out << "[\n" << out.indent(); for (size_t i=0; i<val.size(); ++i) { out << out.indentation() << "[" << (i + (VALUE_C(0))) << "]: "<< boolean_to_str(out,val.data[i]) << '\n'; } out << out.dedent() << out.indentation() << ']'; return ::romp::S_VOID;}

  typedef range_t anon0x1_t; // tk[u] == u receives token
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& anon0x1_t_to_json(::romp::ojstream<O>& json, const anon0x1_t& val) noexcept { json << val; return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& anon0x1_t_to_json(::romp::ojstream<O>& json, const anon0x1_t& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"0..n\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(4)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& anon0x1_t_to_str(::romp::ostream_p& out, const anon0x1_t& val) noexcept { out << ((range_t)val); return ::romp::S_VOID;}

  typedef struct { ::__type__::boolean data[5]; constexpr const size_t size() const {return (5ul);} } anon0x2_t;
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& anon0x2_t_to_json(::romp::ojstream<O>& json, const anon0x2_t& val) noexcept {std::string sep; for (size_t i=(0ul); i<val.size(); ++i) { json << sep << boolean_to_json(json,val.data[i]); sep = ","; } return ::romp::S_VOID;}
#else
  template<class O> const ::romp::stream_void& anon0x2_t_to_json(::romp::ojstream<O>& json, const anon0x2_t& val) noexcept {json << "{\"$type\":\"array-value\",\"type\":\"Array[0..n] of boolean\",\"size\":" << val.size() << ",\"lower-bound\":" << VALUE_C(0) << ",\"upper-bound\":" << VALUE_C(4) << ",\"elements\":["; std::string sep; for (size_t i=(0ul); i<val.size(); ++i) { json << sep << boolean_to_json(json,val.data[i]); sep = ","; } json << "]}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& anon0x2_t_to_str(::romp::ostream_p& out, const anon0x2_t& val) noexcept { out << "[\n" << out.indent(); for (size_t i=0; i<val.size(); ++i) { out << out.indentation() << "[" << (i + (VALUE_C(0))) << "]: "<< boolean_to_str(out,val.data[i]) << '\n'; } out << out.dedent() << out.indentation() << ']'; return ::romp::S_VOID;}

  typedef range_t anon0x3_t; // rules of units
#ifdef __ROMP__SIMPLE_TRACE
...
#else
  template<class O> const ::romp::stream_void& anon0x3_t_to_json(::romp::ojstream<O>& json, const anon0x3_t& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"0..(n - 1)\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(3)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
  ...
  typedef range_t anon0x4_t; // rules of arbiters
#ifdef __ROMP__SIMPLE_TRACE
  template<class O> const ::romp::stream_void& anon0x4_t_to_json(::romp::ojstream<O>& json, const anon0x4_t& val) noexcept { json << val; return ::romp::S_VOID; }
#else
  template<class O> const ::romp::stream_void& anon0x4_t_to_json(::romp::ojstream<O>& json, const anon0x4_t& val) noexcept { json << "{\"$type\":\"range-value\",\"type\":\"0..(n - 1)\",\"min\":" << (VALUE_C(0)) << ",\"max\":" << (VALUE_C(3)) << ",\"value\":" << ((range_t)val) << "}"; return ::romp::S_VOID;}
#endif
  const ::romp::stream_void& anon0x4_t_to_str(::romp::ostream_p& out, const anon0x4_t& val) noexcept { out << ((range_t)val); return ::romp::S_VOID;}
...
namespace __model__ {
  ...
  struct __Model__ {
    ...
    bool __Rule_guard__start_requesting(const ::__type__::anon0x3_t u) const {
      using namespace ::__type__;
      try {
    ...
    void __Rule_action__start_requesting(const ::__type__::anon0x3_t u) {
      using namespace ::__type__;
      try {
    ...
    bool __Rule_guard__start_using(const ::__type__::anon0x3_t u) const {
      using namespace ::__type__;
      try {
    ...
    void __Rule_action__start_using(const ::__type__::anon0x3_t u) {
      using namespace ::__type__;
      try {
        ...
        (Use_b) = (true);
        ((grant).data[((u)) - int_VALUE_C(0)]) = (false);
        (Req_b) = ({ bool res_0 = false; for (int v = ((int)(0)); v <= ((n) - ((int)(1))); v++) { res_0 |= ((req).data[((v)) - int_VALUE_C(0)]); } res_0; });
      } catch (...) { throw ::romp::ModelRuleError(1,::romp::ModelRuleError::ACTION); }
    }

    
    bool __Rule_guard__end_using(const ::__type__::anon0x3_t u) const {
      using namespace ::__type__;
      try {
    ...
    void __Rule_action__end_using(const ::__type__::anon0x3_t u) {
      using namespace ::__type__;
      try {
        ((use).data[((u)) - int_VALUE_C(0)]) = (false);
        (Use_b) = ({ bool res_1 = false; for (int v = ((int)(0)); v <= ((n) - ((int)(1))); v++) { res_1 |= ((use).data[((v)) - int_VALUE_C(0)]); } res_1; });
    ...
    bool __Rule_guard__D_flip_flop(const ::__type__::anon0x4_t u) const {
      using namespace ::__type__;
      try {
    ...
    void __Rule_action__D_flip_flop(const ::__type__::anon0x4_t u) {
      using namespace ::__type__;
      try {
    ...
    bool __Rule_guard__access_granting(const ::__type__::anon0x4_t u) const {
      using namespace ::__type__;
      try {
    ...
    void __Rule_action__access_granting(const ::__type__::anon0x4_t u) {
      using namespace ::__type__;
      try {
    ...
    bool __Rule_guard__token_passing(const ::__type__::anon0x4_t u) const {
      using namespace ::__type__;
      try {
        return (((ntk).data[((u)) - int_VALUE_C(0)]) && (!((flop).data[((u)) - int_VALUE_C(0)])));
    ...
    void __Rule_action__token_passing(const ::__type__::anon0x4_t u) {
      using namespace ::__type__;
      try {
...
#ifdef __ROMP__SIMPLE_TRACE
template<class O> const ::romp::stream_void& __Model___to_json(::romp::ojstream<O>& json, const __Model__& val) noexcept { using namespace ::__type__; json  << reg_to_json(json,val.req) << ',' << reg_to_json(json,val.use) << ',' << reg_to_json(json,val.grant) << ',' << anon0x2_t_to_json(json,val.tk) << ',' << reg_to_json(json,val.flop) << ',' << reg_to_json(json,val.ntk) << ',' << boolean_to_json(json,val.Req_b) << ',' << boolean_to_json(json,val.Use_b) << ',' << reg_to_json(json,val.p_req); return ::romp::S_VOID; }
#else
template<class O> const ::romp::stream_void& __Model___to_json(::romp::ojstream<O>& json, const __Model__& val) noexcept { using namespace ::__type__; json << "{\"$type\":\"record-value\",\"type\":\"__Model__\",\"fields\":[" << "{\"$type\":\"kv-pair\",\"key\":\"req\",\"value\":" << reg_to_json(json,val.req) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"use\",\"value\":" << reg_to_json(json,val.use) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"grant\",\"value\":" << reg_to_json(json,val.grant) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"tk\",\"value\":" << anon0x2_t_to_json(json,val.tk) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"flop\",\"value\":" << reg_to_json(json,val.flop) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"ntk\",\"value\":" << reg_to_json(json,val.ntk) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"Req_b\",\"value\":" << boolean_to_json(json,val.Req_b) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"Use_b\",\"value\":" << boolean_to_json(json,val.Use_b) << "}," << "{\"$type\":\"kv-pair\",\"key\":\"p_req\",\"value\":" << reg_to_json(json,val.p_req)<< "}]}"; return ::romp::S_VOID;}
#endif
const ::romp::stream_void& __Model___to_str(::romp::ostream_p& out, const __Model__& val) noexcept { using namespace ::__type__; out << "{\n" << out.indent() << out.indentation() << "req " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.req) << '\n' << out.indentation() << "use " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.use) << '\n' << out.indentation() << "grant " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.grant) << '\n' << out.indentation() << "tk " << ((::romp::OPTIONS.result_show_type) ? ": Array[0..n] of boolean =" : ":=") << ' ' << anon0x2_t_to_str(out,val.tk) << '\n' << out.indentation() << "flop " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.flop) << '\n' << out.indentation() << "ntk " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.ntk) << '\n' << out.indentation() << "Req_b " << ((::romp::OPTIONS.result_show_type) ? ": __Model__ =" : ":=") << ' ' << boolean_to_str(out,val.Req_b) << '\n' << out.indentation() << "Use_b " << ((::romp::OPTIONS.result_show_type) ? ": __Model__ =" : ":=") << ' ' << boolean_to_str(out,val.Use_b) << '\n' << out.indentation() << "p_req " << ((::romp::OPTIONS.result_show_type) ? ": reg =" : ":=") << ' ' << reg_to_str(out,val.p_req) << '\n' << out.dedent()<< out.indentation() << '}'; return ::romp::S_VOID;}
}
namespace romp {
#ifdef __ROMP__SIMPLE_TRACE
...
#define _ROMP_STATESPACE_COUNT_str "1350851717672992089"
...
#define _ROMP_FUNCTS_LEN (1ul)
  ...
  const ::romp::FunctInfo FUNCT_INFOS[_ROMP_FUNCTS_LEN] = {{"NewToken",{{46,1},{53,5}},"{\"$type\":\"procedure\",\"label\":\"NewToken\",\"params\":[],\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[46,1],\"end\":[53,5]}}","procedure NewToken();"},};
...
#define _ROMP_LIVENESS_PROP_COUNT (0ul) // the number of property rules (after ruleset expansion) in the model
  ...
  const ::romp::PropertyInfo PROPERTY_INFOS[_ROMP_PROPERTIES_LEN] = {{"_no_token_lost_",::romp::PropertyType::INVARIANT,"(tk[n] = false)",0,{{112,1},{112,43}},"{\"$type\":\"property\",\"type\":\"invariant\",\"expr\":\"(tk[n] = false)\",\"label\":\"_no_token_lost_\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[112,1],\"end\":[112,43]}"},{"",::romp::PropertyType::ASSERTION,"(!Use_b)",1,{{66,18},{66,31}},"{\"$type\":\"property\",\"type\":\"assert\",\"label\":\"(!Use_b)\",\"expr\":\"(!Use_b)\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[66,18],\"end\":[66,31]}"},{"",::romp::PropertyType::ASSERTION,"req[u]",2,{{70,18},{70,31}},"{\"$type\":\"property\",\"type\":\"assert\",\"label\":\"req[u]\",\"expr\":\"req[u]\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[70,18],\"end\":[70,31]}"},{"",::romp::PropertyType::ASSERTION,"(!Use_b)",3,{{78,18},{78,31}},"{\"$type\":\"property\",\"type\":\"assert\",\"label\":\"(!Use_b)\",\"expr\":\"(!Use_b)\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[78,18],\"end\":[78,31]}"},};
...
#define _ROMP_STARTSTATE_INFO_LEN (1ul)
  ...
  const ::romp::StartStateInfo STARTSTATE_INFOS[_ROMP_STARTSTATE_INFO_LEN] = {{"startstate2",{{102,1},{110,7}},"{\"$type\":\"startstate\",\"label\":\"startstate2\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[102,1],\"end\":[110,7]}"},};
...
#define _ROMP_RULESETS_LEN (6ul)
  ...
  const ::romp::RuleInfo RULE_SET_INFOS[_ROMP_RULESETS_LEN] = {{"start_requesting",{{56,4},{62,21}},"{\"$type\":\"rule\",\"expr\":\"((!req[u]) & (!use[u]))\",\"label\":\"start_requesting\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[56,4],\"end\":[62,21]}"},{"start_using",{{63,4},{73,21}},"{\"$type\":\"rule\",\"expr\":\"grant[u]\",\"label\":\"start_using\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[63,4],\"end\":[73,21]}"},{"end_using",{{74,4},{80,21}},"{\"$type\":\"rule\",\"expr\":\"use[u]\",\"label\":\"end_using\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[74,4],\"end\":[80,21]}"},{"D_flip_flop",{{84,4},{88,21}},"{\"$type\":\"rule\",\"expr\":\"tk[u]\",\"label\":\"D_flip_flop\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[84,4],\"end\":[88,21]}"},{"access_granting",{{89,4},{93,21}},"{\"$type\":\"rule\",\"expr\":\"(ntk[u] & flop[u])\",\"label\":\"access_granting\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[89,4],\"end\":[93,21]}"},{"token_passing",{{94,4},{98,21}},"{\"$type\":\"rule\",\"expr\":\"(ntk[u] & (!flop[u]))\",\"label\":\"token_passing\",\"loc\":{\"$type\":\"location\",\"file\":\"/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/arbiter.m\",\"start\":[94,4],\"end\":[98,21]}"},};
...
namespace __caller__ {
  ...
  /* --- Rules Generated by: `start_requesting` (RuleSet expansions) --- */
   bool __Rule_guard__start_requesting__0(const State_t& s){return s.__Rule_guard__start_requesting((::__type__::anon0x3_t) 0); }
   void __Rule_action__start_requesting__0(State_t& s){s.__Rule_action__start_requesting((::__type__::anon0x3_t) 0); }
   bool __Rule_guard__start_requesting__1(const State_t& s){return s.__Rule_guard__start_requesting((::__type__::anon0x3_t) 1); }
   void __Rule_action__start_requesting__1(State_t& s){s.__Rule_action__start_requesting((::__type__::anon0x3_t) 1); }
   bool __Rule_guard__start_requesting__2(const State_t& s){return s.__Rule_guard__start_requesting((::__type__::anon0x3_t) 2); }
   void __Rule_action__start_requesting__2(State_t& s){s.__Rule_action__start_requesting((::__type__::anon0x3_t) 2); }
   bool __Rule_guard__start_requesting__3(const State_t& s){return s.__Rule_guard__start_requesting((::__type__::anon0x3_t) 3); }
   void __Rule_action__start_requesting__3(State_t& s){s.__Rule_action__start_requesting((::__type__::anon0x3_t) 3); }
  /* --- Rules Generated by: `start_using` (RuleSet expansions) --- */
   bool __Rule_guard__start_using__0(const State_t& s){return s.__Rule_guard__start_using((::__type__::anon0x3_t) 0); }
   void __Rule_action__start_using__0(State_t& s){s.__Rule_action__start_using((::__type__::anon0x3_t) 0); }
   bool __Rule_guard__start_using__1(const State_t& s){return s.__Rule_guard__start_using((::__type__::anon0x3_t) 1); }
   void __Rule_action__start_using__1(State_t& s){s.__Rule_action__start_using((::__type__::anon0x3_t) 1); }
   bool __Rule_guard__start_using__2(const State_t& s){return s.__Rule_guard__start_using((::__type__::anon0x3_t) 2); }
   void __Rule_action__start_using__2(State_t& s){s.__Rule_action__start_using((::__type__::anon0x3_t) 2); }
   bool __Rule_guard__start_using__3(const State_t& s){return s.__Rule_guard__start_using((::__type__::anon0x3_t) 3); }
   void __Rule_action__start_using__3(State_t& s){s.__Rule_action__start_using((::__type__::anon0x3_t) 3); }
  /* --- Rules Generated by: `end_using` (RuleSet expansions) --- */
   bool __Rule_guard__end_using__0(const State_t& s){return s.__Rule_guard__end_using((::__type__::anon0x3_t) 0); }
   void __Rule_action__end_using__0(State_t& s){s.__Rule_action__end_using((::__type__::anon0x3_t) 0); }
   bool __Rule_guard__end_using__1(const State_t& s){return s.__Rule_guard__end_using((::__type__::anon0x3_t) 1); }
   void __Rule_action__end_using__1(State_t& s){s.__Rule_action__end_using((::__type__::anon0x3_t) 1); }
   bool __Rule_guard__end_using__2(const State_t& s){return s.__Rule_guard__end_using((::__type__::anon0x3_t) 2); }
   void __Rule_action__end_using__2(State_t& s){s.__Rule_action__end_using((::__type__::anon0x3_t) 2); }
   bool __Rule_guard__end_using__3(const State_t& s){return s.__Rule_guard__end_using((::__type__::anon0x3_t) 3); }
   void __Rule_action__end_using__3(State_t& s){s.__Rule_action__end_using((::__type__::anon0x3_t) 3); }
  /* --- Rules Generated by: `D_flip_flop` (RuleSet expansions) --- */
   bool __Rule_guard__D_flip_flop__0(const State_t& s){return s.__Rule_guard__D_flip_flop((::__type__::anon0x4_t) 0); }
   void __Rule_action__D_flip_flop__0(State_t& s){s.__Rule_action__D_flip_flop((::__type__::anon0x4_t) 0); }
   bool __Rule_guard__D_flip_flop__1(const State_t& s){return s.__Rule_guard__D_flip_flop((::__type__::anon0x4_t) 1); }
   void __Rule_action__D_flip_flop__1(State_t& s){s.__Rule_action__D_flip_flop((::__type__::anon0x4_t) 1); }
   bool __Rule_guard__D_flip_flop__2(const State_t& s){return s.__Rule_guard__D_flip_flop((::__type__::anon0x4_t) 2); }
   void __Rule_action__D_flip_flop__2(State_t& s){s.__Rule_action__D_flip_flop((::__type__::anon0x4_t) 2); }
   bool __Rule_guard__D_flip_flop__3(const State_t& s){return s.__Rule_guard__D_flip_flop((::__type__::anon0x4_t) 3); }
   void __Rule_action__D_flip_flop__3(State_t& s){s.__Rule_action__D_flip_flop((::__type__::anon0x4_t) 3); }
  /* --- Rules Generated by: `access_granting` (RuleSet expansions) --- */
   bool __Rule_guard__access_granting__0(const State_t& s){return s.__Rule_guard__access_granting((::__type__::anon0x4_t) 0); }
   void __Rule_action__access_granting__0(State_t& s){s.__Rule_action__access_granting((::__type__::anon0x4_t) 0); }
   bool __Rule_guard__access_granting__1(const State_t& s){return s.__Rule_guard__access_granting((::__type__::anon0x4_t) 1); }
   void __Rule_action__access_granting__1(State_t& s){s.__Rule_action__access_granting((::__type__::anon0x4_t) 1); }
   bool __Rule_guard__access_granting__2(const State_t& s){return s.__Rule_guard__access_granting((::__type__::anon0x4_t) 2); }
   void __Rule_action__access_granting__2(State_t& s){s.__Rule_action__access_granting((::__type__::anon0x4_t) 2); }
   bool __Rule_guard__access_granting__3(const State_t& s){return s.__Rule_guard__access_granting((::__type__::anon0x4_t) 3); }
   void __Rule_action__access_granting__3(State_t& s){s.__Rule_action__access_granting((::__type__::anon0x4_t) 3); }
  /* --- Rules Generated by: `token_passing` (RuleSet expansions) --- */
   bool __Rule_guard__token_passing__0(const State_t& s){return s.__Rule_guard__token_passing((::__type__::anon0x4_t) 0); }
   void __Rule_action__token_passing__0(State_t& s){s.__Rule_action__token_passing((::__type__::anon0x4_t) 0); }
   bool __Rule_guard__token_passing__1(const State_t& s){return s.__Rule_guard__token_passing((::__type__::anon0x4_t) 1); }
   void __Rule_action__token_passing__1(State_t& s){s.__Rule_action__token_passing((::__type__::anon0x4_t) 1); }
   bool __Rule_guard__token_passing__2(const State_t& s){return s.__Rule_guard__token_passing((::__type__::anon0x4_t) 2); }
   void __Rule_action__token_passing__2(State_t& s){s.__Rule_action__token_passing((::__type__::anon0x4_t) 2); }
   bool __Rule_guard__token_passing__3(const State_t& s){return s.__Rule_guard__token_passing((::__type__::anon0x4_t) 3); }
   void __Rule_action__token_passing__3(State_t& s){s.__Rule_action__token_passing((::__type__::anon0x4_t) 3); }
