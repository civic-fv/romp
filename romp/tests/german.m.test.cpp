...
namespace __type__ {
  ...
  typedef struct { ::__type__::CACHE data[4]; constexpr const size_t size() const {return (4ul);} } anon0x0_t; // Caches
#ifdef __ROMP__SIMPLE_TRACE
  ...
  typedef struct { ::__type__::MSG data[4]; constexpr const size_t size() const {return (4ul);} } anon0x1_t; // Channels for Req*
#ifdef __ROMP__SIMPLE_TRACE
  ...
  typedef struct { ::__type__::MSG data[4]; constexpr const size_t size() const {return (4ul);} } anon0x2_t; // Channels for Gnt* and Inv
#ifdef __ROMP__SIMPLE_TRACE
  ...
  typedef struct { ::__type__::MSG data[4]; constexpr const size_t size() const {return (4ul);} } anon0x3_t; // Channels for InvAck
#ifdef __ROMP__SIMPLE_TRACE
  ...
  typedef struct { ::__type__::boolean data[4]; constexpr const size_t size() const {return (4ul);} } anon0x4_t; // Nodes to be invalidated
#ifdef __ROMP__SIMPLE_TRACE
  ...
  typedef struct { ::__type__::boolean data[4]; constexpr const size_t size() const {return (4ul);} } anon0x5_t; // Nodes having S or E copies
#ifdef __ROMP__SIMPLE_TRACE
