...
#define RULE_TAKEN_LIMIT 20
#define PACK_STATE 1
#define SCHEDULE_BITS 5ul
...
static void swap_pid(struct state *s __attribute__((unused)), size_t x __attribute__((unused)), size_t y __attribute__((unused))) {
  if (((size_t)47ull) + x * ((size_t)3ull) != ((size_t)47ull) + y * ((size_t)3ull)) {
    raw_value_t a = handle_read_raw(s, state_handle(s, ((size_t)47ull) + x * ((size_t)3ull), 3ull));
    raw_value_t b = handle_read_raw(s, state_handle(s, ((size_t)47ull) + y * ((size_t)3ull), 3ull));
    handle_write_raw(s, state_handle(s, ((size_t)47ull) + y * ((size_t)3ull), 3ull), a);
    handle_write_raw(s, state_handle(s, ((size_t)47ull) + x * ((size_t)3ull), 3ull), b);
  }
  ...
  for (size_t i0 = 0; i0 < ((size_t)5ull); i0++) {
    if (x != y) {
      raw_value_t v = handle_read_raw(s, state_handle(s, ((size_t)32ull) + i0 * ((size_t)3ull), ((size_t)3ull)));
      if (v != 0) {
        if (v - 1 == (raw_value_t)x) {
          handle_write_raw(s, state_handle(s, ((size_t)32ull) + i0 * ((size_t)3ull), ((size_t)3ull)), y + 1);
        } else if (v - 1 == (raw_value_t)y) {
          handle_write_raw(s, state_handle(s, ((size_t)32ull) + i0 * ((size_t)3ull), ((size_t)3ull)), x + 1);
        }
      }
    }
  }
  if (((size_t)71ull) + x * ((size_t)3ull) != ((size_t)71ull) + y * ((size_t)3ull)) {
    raw_value_t a = handle_read_raw(s, state_handle(s, ((size_t)71ull) + x * ((size_t)3ull), 3ull));
    raw_value_t b = handle_read_raw(s, state_handle(s, ((size_t)71ull) + y * ((size_t)3ull), 3ull));
    handle_write_raw(s, state_handle(s, ((size_t)71ull) + y * ((size_t)3ull), 3ull), a);
    handle_write_raw(s, state_handle(s, ((size_t)71ull) + x * ((size_t)3ull), 3ull), b);
  }
  for (size_t i0 = 0; i0 < ((size_t)4ull); i0++) {
  }
  for (size_t i0 = 0; i0 < ((size_t)4ull); i0++) {
    if (x != y) {
      raw_value_t v = handle_read_raw(s, state_handle(s, ((size_t)83ull) + i0 * ((size_t)3ull), ((size_t)3ull)));
      if (v != 0) {
        if (v - 1 == (raw_value_t)x) {
          handle_write_raw(s, state_handle(s, ((size_t)83ull) + i0 * ((size_t)3ull), ((size_t)3ull)), y + 1);
        } else if (v - 1 == (raw_value_t)y) {
          handle_write_raw(s, state_handle(s, ((size_t)83ull) + i0 * ((size_t)3ull), ((size_t)3ull)), x + 1);
        }
      }
    }
  }
  for (size_t i0 = 0; i0 < ((size_t)8ull); i0++) {
    if (x != y) {
      raw_value_t v = handle_read_raw(s, state_handle(s, ((size_t)8ull) + i0 * ((size_t)3ull), ((size_t)3ull)));
      if (v != 0) {
        if (v - 1 == (raw_value_t)x) {
          handle_write_raw(s, state_handle(s, ((size_t)8ull) + i0 * ((size_t)3ull), ((size_t)3ull)), y + 1);
        } else if (v - 1 == (raw_value_t)y) {
          handle_write_raw(s, state_handle(s, ((size_t)8ull) + i0 * ((size_t)3ull), ((size_t)3ull)), x + 1);
        }
      }
    }
  }
...
static void state_canonicalise_exhaustive(struct state *s __attribute__((unused))) {
  ...
  {
    size_t stack_pid[((size_t)4ull)] = { 0 };

    size_t schedule_pid[((size_t)4ull)] = { 0 };
    if (USE_SCALARSET_SCHEDULES) {
      size_t stack[((size_t)4ull)];
      size_t index = schedule_read_pid(&candidate);
      index_to_permutation(index, schedule_pid, stack, ((size_t)4ull));
    }
    ...
    for (size_t i0 = 0; i0 < ((size_t)4ull); ) {
      if (stack_pid[i0] < i0) {
        ...
        if (USE_SCALARSET_SCHEDULES) {
          ...
          size_t index = permutation_to_index(schedule_pid, stack, working, ((size_t)4ull));
...
static void state_canonicalise_heuristic(struct state *s __attribute__((unused))) {
...

  {
    ...
    sort_pid(s, schedule, 0, ((size_t)4ull) - 1);
    /* save selected schedule to map this back for later more
     * comprehensible counterexample traces
     */
    if (USE_SCALARSET_SCHEDULES) {
...
static const value_t ru_N __attribute__((unused)) = VALUE_C(4);

static const value_t ru_LHL __attribute__((unused)) = VALUE_C(4);

static const value_t ru_BL __attribute__((unused)) = VALUE_C(8);

static const value_t ru_MSL __attribute__((unused)) = VALUE_C(2);
...
static bool ru_print_bug(const char *rule_name __attribute__((unused)), struct state *NONNULL s __attribute__((unused)), struct handle ru_tmp) {
  const struct handle ru_P __attribute__((unused)) = state_handle(s, 47ull, 12ull);
  const struct handle ru_Q __attribute__((unused)) = state_handle(s, 59ull, 12ull);
  const struct handle ru_turn __attribute__((unused)) = state_handle(s, 32ull, 15ull);
  const struct handle ru_localj __attribute__((unused)) = state_handle(s, 71ull, 12ull);
  const struct handle ru_lock_hist __attribute__((unused)) = state_handle(s, 83ull, 12ull);
  const struct handle ru_bug __attribute__((unused)) = state_handle(s, 8ull, 24ull);
  const struct handle ru_lh_size __attribute__((unused)) = state_handle(s, 95ull, 3ull);
  const struct handle ru_b_size __attribute__((unused)) = state_handle(s, 0ull, 4ull);
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  {
  put("Bug := [ ");
  {
  for (size_t i0 = 0; i0 < 8ull; ++i0) {
{
  raw_value_t v = handle_read_raw(s, ((struct handle){ .base = ru_bug.base + (ru_bug.offset + (i0 * ((size_t)3ull))) / CHAR_BIT, .offset = (ru_bug.offset + (i0 * ((size_t)3ull))) % CHAR_BIT, .width = 3ull }));
  raw_value_t v_previous = 0;
  const struct state *previous = NULL;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = ((struct handle){ .base = (uint8_t*)previous->data + (ru_bug.base - (const uint8_t*)s->data), .offset = ru_bug.offset, .width = ru_bug.width }).base + (((struct handle){ .base = (uint8_t*)previous->data + (ru_bug.base - (const uint8_t*)s->data), .offset = ru_bug.offset, .width = ru_bug.width }).offset + (i0 * ((size_t)3ull))) / CHAR_BIT, .offset = (((struct handle){ .base = (uint8_t*)previous->data + (ru_bug.base - (const uint8_t*)s->data), .offset = ru_bug.offset, .width = ru_bug.width }).offset + (i0 * ((size_t)3ull))) % CHAR_BIT, .width = 3ull }));
  ...
  if (previous == NULL || v != v_previous) {
    if (0 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("bug"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put("\" value=\"");
    } else {
      do { put("bug"); put("["); put_val((value_t)((raw_value_t)i0 + (raw_value_t)VALUE_C(0))); put("]"); } while (0);
      put(":");
...
static int guard0(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:123.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:123.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:123.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) == VALUE_C(0)) ? 1 : 0;
...
static bool rule0(struct state *NONNULL s, struct handle ru_i) {
  ...
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  {
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:125.5-18: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:125.5-13: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:125.12: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(1));
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:126.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:126.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:126.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(1));
  }
...
static int guard1(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:130.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:130.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:130.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) == VALUE_C(1)) ? 1 : 0;
...
static bool rule1(struct state *NONNULL s, struct handle ru_i) {
  ...
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  {
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.5-21: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_Q, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.13-21: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.13-21: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:132.20: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))));
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:133.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:133.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:133.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(2));
  }
...
static int guard2(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:137.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:137.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:137.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) == VALUE_C(2)) ? 1 : 0;
...
static bool rule2(struct state *NONNULL s, struct handle ru_i) {
  ...
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  {
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.5-25: ", rule_name, "turn[localj[i]]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.5-19: ", rule_name, "turn[localj[i]]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_turn, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.10-18: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.10-18: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.17: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)))), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:139.25: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i));
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:140.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:140.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:140.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(3));
  }
...
static int guard3(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:144.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:144.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:144.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) == VALUE_C(3)) ? 1 : 0;
...
if (!(!(handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.14: ", rule_name, "k", s, VALUE_C(0), VALUE_C(3), ru_k) != handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.17: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)) || (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.26-29: ", rule_name, "Q[k]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.26-29: ", rule_name, "Q[k]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_Q, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.28: ", rule_name, "k", s, VALUE_C(0), VALUE_C(3), ru_k))) < handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.31-39: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.31-39: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:147.38: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)))))) { result = false; break; }    /* If this iteration runs right up to the type limits, the last
 ...
 result; }) || (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.12-26: ", rule_name, "turn[localj[i]]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.12-26: ", rule_name, "turn[localj[i]]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_turn, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.17-25: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.17-25: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.24: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))))) != handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:149.31: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) {
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.7-32: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.7-15: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.14: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), add("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.20-32: ", rule_name, "(localj[i] + 1)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.20-28: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.20-28: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:151.27: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))), VALUE_C(1)));
if (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:152.12-20: ", rule_name, "localj[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:152.12-20: ", rule_name, "localj[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_localj, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:152.19: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) < VALUE_C(4)) {
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:154.9-18: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:154.9-12: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:154.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(1));
}
else  {
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:156.9-18: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:156.9-12: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:156.11: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(4));
}
;
}
;
...
static int guard4(const struct state *NONNULL s __attribute__((unused)), struct handle ru_i __attribute__((unused))) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:162.5-8: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:162.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:162.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i))) == VALUE_C(4)) ? 1 : 0;
...
static bool rule4(struct state *NONNULL s, struct handle ru_i) {
  ...
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  {
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:164.5-13: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:164.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_Q, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:164.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(1));
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:165.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:165.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:165.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(0));
  if (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:167.8-20: ", rule_name, "bug_is_full", s, VALUE_C(0), VALUE_C(1), ru_bug_is_full))  {
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:169.7-29: ", rule_name, "lock_hist[lh_size]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:169.7-24: ", rule_name, "lock_hist[lh_size]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_lock_hist, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:169.17-23: ", rule_name, "lh_size", s, VALUE_C(0), VALUE_C(3), ru_lh_size)), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:169.29: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i));
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:170.7-36: ", rule_name, "lh_size", s, VALUE_C(0), VALUE_C(3), ru_lh_size, mod("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:170.18-36: ", rule_name, "((lh_size + 1) % LHL)", s, add("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:170.18-30: ", rule_name, "(lh_size + 1)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:170.19-25: ", rule_name, "lh_size", s, VALUE_C(0), VALUE_C(3), ru_lh_size), VALUE_C(1)), VALUE_C(4)));
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:171.7-32: ", rule_name, "lh_is_full", s, VALUE_C(0), VALUE_C(1), ru_lh_is_full, (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:171.21-27: ", rule_name, "lh_size", s, VALUE_C(0), VALUE_C(3), ru_lh_size) == VALUE_C(0)));
}
else  {
if (__builtin_expect(!(!handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:173.16-26: ", rule_name, "bug_is_full", s, VALUE_C(0), VALUE_C(1), ru_bug_is_full)), 0)) {
error(s, "Assertion failed: %s:173.7-66: %s", "/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m", "Bug is full, but added to it anyway!");
};
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:174.7-22: ", rule_name, "bug[b_size]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:174.7-17: ", rule_name, "bug[b_size]", s, 3ull, VALUE_C(0), VALUE_C(7), ru_bug, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:174.11-16: ", rule_name, "b_size", s, VALUE_C(0), VALUE_C(7), ru_b_size)), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:174.22: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i));
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:175.7-33: ", rule_name, "b_size", s, VALUE_C(0), VALUE_C(7), ru_b_size, mod("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:175.17-33: ", rule_name, "((b_size + 1) % BL)", s, add("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:175.17-28: ", rule_name, "(b_size + 1)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:175.18-23: ", rule_name, "b_size", s, VALUE_C(0), VALUE_C(7), ru_b_size), VALUE_C(1)), VALUE_C(8)));
if (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:176.11-16: ", rule_name, "b_size", s, VALUE_C(0), VALUE_C(7), ru_b_size) == VALUE_C(0)) {
handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:178.9-27: ", rule_name, "bug_is_full", s, VALUE_C(0), VALUE_C(1), ru_bug_is_full, VALUE_C(1));
}
;
}
;
...
static bool startstate0(struct state *NONNULL s) {
  ...
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:189.5-14: ", rule_name, "P[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:189.5-8: ", rule_name, "P[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:189.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(0));
  handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:190.5-13: ", rule_name, "Q[i]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:190.5-8: ", rule_name, "Q[i]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_Q, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:190.7: ", rule_name, "i", s, VALUE_C(0), VALUE_C(3), ru_i)), VALUE_C(0));
...
;
  ...
  #pragma GCC diagnostic ignored "-Wtype-limits"
#endif
  ASSERT(lb >= VALUE_C(0) && lb <= VALUE_C(4) && "iteration lower bound exceeds type limits");
  ASSERT(ub >= VALUE_C(0) && ub <= VALUE_C(4) && "iteration upper bound exceeds type limits");
#if !defined(__clang__) && defined(__GNUC__)
  #pragma GCC diagnostic pop
#endif
  for (raw_value_t _ru1_i = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))); _ru1_i == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(0)))) || (lb < ub && ((value_t)(_ru1_i - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) <= ub) || (lb > ub && ((value_t)(_ru1_i - (raw_value_t)1 + (raw_value_t)(VALUE_C(0)))) >= ub); _ru1_i += step) {
    ...
    struct handle ru_i = { .base = _ru2_i, .offset = 0, .width = ((size_t)3ull) };
    handle_write_raw(s, ru_i, _ru1_i);
  handle_zero(handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:194.14-20: ", rule_name, "turn[i]", s, 3ull, VALUE_C(0), VALUE_C(4), ru_turn, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:194.19: ", rule_name, "i", s, VALUE_C(0), VALUE_C(4), ru_i)));
    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
...
;
  ...
  for (size_t i0 = 0; i0 < ((size_t)4ull); i0++) {
    ...
    handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:200.3-21: ", rule_name, "lh_is_full", s, VALUE_C(0), VALUE_C(1), ru_lh_is_full, VALUE_C(0));
    handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:201.3-22: ", rule_name, "bug_is_full", s, VALUE_C(0), VALUE_C(1), ru_bug_is_full, VALUE_C(0));
    handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:202.3-14: ", rule_name, "lh_size", s, VALUE_C(0), VALUE_C(3), ru_lh_size, VALUE_C(0));
    handle_write("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:203.3-13: ", rule_name, "b_size", s, VALUE_C(0), VALUE_C(7), ru_b_size, VALUE_C(0));
    do {
  ...
  for (size_t i0 = 0; i0 < ((size_t)4ull); i0++) {
    ...
    do {
  struct handle root = ru_bug;
  for (size_t i0 = 0; i0 < ((size_t)8ull); i0++) {
    handle_write_raw(s, (struct handle){ .base = root.base + (root.offset + ((size_t)0) + i0 * ((size_t)3ull)) / CHAR_BIT, .offset = (root.offset + ((size_t)0) + i0 * ((size_t)3ull)) % CHAR_BIT, .width = 3ull }, 1);
  }
} while (0);
    if (VALUE_C(2) < VALUE_C(2)) {
error(s, "%s", "CONFIG ERROR: `MSL` needs to >= 2 to be a proper subseq !!");
}
;
    if (VALUE_C(2) > VALUE_C(4)) {
...
if ((((handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:217.9-10: ", rule_name, "i1", s, VALUE_C(0), VALUE_C(3), ru_i1) != handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:217.15-16: ", rule_name, "i2", s, VALUE_C(0), VALUE_C(3), ru_i2)) && (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:218.9-13: ", rule_name, "P[i1]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:218.9-13: ", rule_name, "P[i1]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:218.11-12: ", rule_name, "i1", s, VALUE_C(0), VALUE_C(3), ru_i1))) == VALUE_C(4))) && (handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:219.9-13: ", rule_name, "P[i2]", s, VALUE_C(0), VALUE_C(4), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:219.9-13: ", rule_name, "P[i2]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_P, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:219.11-12: ", rule_name, "i2", s, VALUE_C(0), VALUE_C(3), ru_i2))) == VALUE_C(4)))) { result = true; break; }    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
    {
...
static __attribute__((unused)) bool property1(const struct state *NONNULL s) {
  ...
  const struct handle ru_lh_is_full __attribute__((unused)) = state_handle(s, 4ull, 2ull);
  const struct handle ru_bug_is_full __attribute__((unused)) = state_handle(s, 6ull, 2ull);
  return ((!handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:226.7-18: ", rule_name, "lh_is_full", s, VALUE_C(0), VALUE_C(1), ru_lh_is_full)) || (!({ bool result = false; {
  const value_t lb = VALUE_C(2);
  const value_t ub = ((VALUE_C(8) < VALUE_C(4)) ? VALUE_C(8) : VALUE_C(4));
  const raw_value_t step = (raw_value_t)(ub >= lb ? 1 : -1);
  if (step == 0) {
    error(s, "infinite loop due to step being 0");
  }
  ...
  #pragma GCC diagnostic ignored "-Wtype-limits"
#endif
  ASSERT(lb >= VALUE_C(2) && lb <= VALUE_C(4) && "iteration lower bound exceeds type limits");
  ASSERT(ub >= VALUE_C(2) && ub <= VALUE_C(4) && "iteration upper bound exceeds type limits");
#if !defined(__clang__) && defined(__GNUC__)
  #pragma GCC diagnostic pop
#endif
  for (raw_value_t _ru1_l = ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(2)))); _ru1_l == ((raw_value_t)((raw_value_t)(((raw_value_t)lb) + (raw_value_t)1) - (raw_value_t)(VALUE_C(2)))) || (lb < ub && ((value_t)(_ru1_l - (raw_value_t)1 + (raw_value_t)(VALUE_C(2)))) <= ub) || (lb > ub && ((value_t)(_ru1_l - (raw_value_t)1 + (raw_value_t)(VALUE_C(2)))) >= ub); _ru1_l += step) {
    uint8_t _ru2_l[BITS_TO_BYTES(((size_t)2ull))] = { 0 };
    struct handle ru_l = { .base = _ru2_l, .offset = 0, .width = ((size_t)2ull) };
    handle_write_raw(s, ru_l, _ru1_l);
if (({ bool result = false; {
  const value_t lb = VALUE_C(0);
  const value_t ub = sub("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:228.28-33: ", rule_name, "(BL - l)", s, VALUE_C(8), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:228.32: ", rule_name, "l", s, VALUE_C(2), VALUE_C(4), ru_l));
  const raw_value_t step = (raw_value_t)(ub >= lb ? 1 : -1);
  if (step == 0) {
    error(s, "infinite loop due to step being 0");
  }
...
if (({ bool result = false; {
  const value_t lb = VALUE_C(0);
  const value_t ub = sub("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:229.31-37: ", rule_name, "(LHL - l)", s, VALUE_C(4), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:229.36: ", rule_name, "l", s, VALUE_C(2), VALUE_C(4), ru_l));
  const raw_value_t step = (raw_value_t)(ub >= lb ? 1 : -1);
  if (step == 0) {
    error(s, "infinite loop due to step being 0");
  }
...
if (({ bool result = true; {
  const value_t lb = VALUE_C(0);
  const value_t ub = sub("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:230.32-36: ", rule_name, "(l - 1)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:230.33: ", rule_name, "l", s, VALUE_C(2), VALUE_C(4), ru_l), VALUE_C(1));
  const raw_value_t step = (raw_value_t)(ub >= lb ? 1 : -1);
  if (step == 0) {
    error(s, "infinite loop due to step being 0");
  }
...
if (!(handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.17-26: ", rule_name, "bug[(b_i + j)]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.17-26: ", rule_name, "bug[(b_i + j)]", s, 3ull, VALUE_C(0), VALUE_C(7), ru_bug, add("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.21-25: ", rule_name, "(b_i + j)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.21-23: ", rule_name, "b_i", s, VALUE_C(-9223372036854775807), VALUE_C(9223372036854775807), ru_b_i), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.25: ", rule_name, "j", s, VALUE_C(-9223372036854775807), VALUE_C(9223372036854775807), ru_j)))) == handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.30-46: ", rule_name, "lock_hist[(lh_i + j)]", s, VALUE_C(0), VALUE_C(3), handle_index("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.30-46: ", rule_name, "lock_hist[(lh_i + j)]", s, 3ull, VALUE_C(0), VALUE_C(3), ru_lock_hist, add("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.40-45: ", rule_name, "(lh_i + j)", s, handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.40-43: ", rule_name, "lh_i", s, VALUE_C(-9223372036854775807), VALUE_C(9223372036854775807), ru_lh_i), handle_read("/mnt/g/My Drive/School/UofU/proj/romp/rumur-romp/romp/tests/n_peterson.bug.m:231.45: ", rule_name, "j", s, VALUE_C(-9223372036854775807), VALUE_C(9223372036854775807), ru_j)))))) { result = false; break; }    /* If this iteration runs right up to the type limits, the last
     * increment will overflow and fail to terminate, so we guard
     * against that here.
     */
    {
 ...
 result; })) { result = true; break; }    /* If this iteration runs right up to the type limits, the last
     ...
     */
    {
       ...
       */
      const raw_value_t max_ = RAW_VALUE_MAX;
      if (ub >= lb && (value_t)step > 0 && ((value_t)(max_ - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(2)))) < ub && _ru1_l > RAW_VALUE_MAX - step) {
        break;
      }
    }
#ifdef __clang__
  ...
  #pragma GCC diagnostic ignored "-Wsign-compare"
#endif
    {
      /* see above explanation of why we use an extra constant here */
      const raw_value_t min_ = RAW_VALUE_MIN;
      if (ub <= lb && (value_t)step < 0 && ((value_t)(min_ - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(2)))) > ub && ((value_t)(_ru1_l - (raw_value_t)1 + (raw_value_t)(VALUE_C(2)))) < ((value_t)(RAW_VALUE_MIN - step - (raw_value_t)1 + (raw_value_t)(VALUE_C(2))))) {
#ifdef __clang__
  #pragma clang diagnostic pop
#elif defined(__GNUC__)
  #pragma GCC diagnostic pop
      ...
      "failed to find permuted scalarset index");
{
  ...
  if (previous == NULL || v != v_previous) {
    ...
    if (v == 0) {
      ...
      put_val(decode_value(VALUE_C(0), VALUE_C(4), v));
    }
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("\"/>");
    }
...
}
{
  ...
  if (previous == NULL || v != v_previous) {
    ...
    if (v == 0) {
      ...
      put_val(decode_value(VALUE_C(0), VALUE_C(3), v));
    }
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("\"/>");
    }
...
{
  raw_value_t v = handle_read_raw(s, ru_b_size);
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = (uint8_t*)previous->data + (ru_b_size.base - (const uint8_t*)s->data), .offset = ru_b_size.offset, .width = ru_b_size.width }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("b_size"); } while (0);
      put("\" value=\"");
    } else {
      do { put("b_size"); } while (0);
      put(":");
    ...
    if (v == 0) {
      ...
      put_val(decode_value(VALUE_C(0), VALUE_C(7), v));
    }
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("\"/>");
    }
...
{
  raw_value_t v = handle_read_raw(s, ru_bug_is_full);
  raw_value_t v_previous = 0;
  if (previous != NULL) {
    v_previous = handle_read_raw(previous, ((struct handle){ .base = (uint8_t*)previous->data + (ru_bug_is_full.base - (const uint8_t*)s->data), .offset = ru_bug_is_full.offset, .width = ru_bug_is_full.width }));
  }
  if (previous == NULL || v != v_previous) {
    if (1 && MACHINE_READABLE_OUTPUT) {
      put("<state_component name=\"");
      do { put("bug_is_full"); } while (0);
      put("\" value=\"");
    } else {
      do { put("bug_is_full"); } while (0);
      put(":");
...
static void state_print_field_offsets(void) {
  ...
  put("-byte aligned\n");
  put("	* field P is located at state offset 47 bits\n");
  put("	* field Q is located at state offset 59 bits\n");
  put("	* field turn is located at state offset 32 bits\n");
  put("	* field localj is located at state offset 71 bits\n");
  put("	* field lock_hist is located at state offset 83 bits\n");
  put("	* field bug is located at state offset 8 bits\n");
  put("	* field lh_size is located at state offset 95 bits\n");
  put("	* field b_size is located at state offset 0 bits\n");
  put("	* field lh_is_full is located at state offset 4 bits\n");
  put("	* field bug_is_full is located at state offset 6 bits\n");
  put("\n");
}
