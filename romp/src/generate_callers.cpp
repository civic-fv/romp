    ...
    void visit_simplerule(const SimpleRule& n) final {
      ...
      for (const Sig& sig : sigs) {
        ...
        gen   << gen.indentation()
              ...
              << " bool "
              << _guard
              << "(const " ROMP_STATE_TYPE "& s)" /* " throw (" ROMP_MODEL_EXCEPTION_TYPE ")" */ "{ using namespace " ROMP_MODEL_NAMESPACE_NAME "; "
              "return s." ROMP_RULE_GUARD_PREFIX << sig/* _str */ << "; }\n"
              << gen.indentation()
              << gen.M_RULE_ACTION__FUNC_ATTRS
              << " void "
              << _action
              << "(" ROMP_STATE_TYPE "& s)"  /* " throw (" ROMP_MODEL_EXCEPTION_TYPE ")" */  "{ using namespace " ROMP_MODEL_NAMESPACE_NAME "; "
