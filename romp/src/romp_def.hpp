...
#define ROMP_TYPE_NAMESPACE "" ROMP_UTIL_NAMESPACE_NAME

#define ROMP_TYPE_NAME_ARRAY "ArrayType"
#define ROMP_TYPE_ARRAY "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_ARRAY
#define ROMP_TYPE_NAME_BOOLEAN "BooleanType"
#define ROMP_TYPE_BOOLEAN "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_BOOLEAN
#define ROMP_TYPE_NAME_ENUM "EnumType"
#define ROMP_TYPE_ENUM "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_ENUM
#define ROMP_TYPE_NAME_MULTISET "MultisetType"
#define ROMP_TYPE_MULTISET "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_MULTISET
#define ROMP_TYPE_NAME_RANGE "RangeType"
#define ROMP_TYPE_RANGE "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_RANGE
#define ROMP_TYPE_NAME_RECORD "RecordType"
#define ROMP_TYPE_RECORD "::" ROMP_TYPE_NAMESPACE "::" ROMP_TYPE_NAME_RECORD
#define ROMP_TYPE_NAME_SCALARSET "ScalarsetType"
...
#define ROMP_SCALAR_ENUM_UNDEFINED_DISPLAY_NAME "<undef>"
...
#define ROMP_CALLER_RULESETS_DECL "const " ROMP_CALLER_RULESETS_TYPE " " ROMP_CALLER_RULESETS_VAR_NAME "[]"
...
#define ROMP_INFO_RULESETS_DECL "const " ROMP_INFO_RULESET_TYPE " " ROMP_INFO_RULESETS_VAR_NAME "[]"
...
#define ROMP_CALLER_PROPERTIES_DECL "const " ROMP_CALLER_PROPERTY_TYPE " " ROMP_CALLER_PROPERTIES_VAR_NAME "[]"
...
#define ROMP_INFO_PROPERTIES_DECL "const " ROMP_INFO_PROPERTY_TYPE " " ROMP_INFO_PROPERTIES_VAR_NAME "[]"
...
#define ROMP_CALLER_STARTSTATES_DECL "const " ROMP_UTIL_NAMESPACE "::StartState " ROMP_CALLER_STARTSTATE_VAR_NAME "[]"
#define ROMP_STARTSTATE_INFOS_LEN "_ROMP_STARTSTATE_INFO_LEN"
#define ROMP_INFO_STARTSTATE_VAR_NAME "STARTSTATE_INFOS"
#define ROMP_INFO_STARTSTATES_DECL "const " ROMP_UTIL_NAMESPACE "::StartStateInfo " ROMP_INFO_STARTSTATE_VAR_NAME "[]"
...
#define ROMP_INFO_ERRORS_DECL "const " ROMP_UTIL_NAMESPACE "::MErrorInfo " ROMP_INFO_ERRORS_VAR_NAME "[]"
...
#define ROMP_INFO_FUNCTS_DECL "const " ROMP_UTIL_NAMESPACE "::FunctInfo " ROMP_INFO_FUNCTS_VAR_NAME "[]"
...
#define ROMP_MODEL_ERROR_TYPE_TYPE ROMP_UTIL_NAMESPACE "::" "ModelTypeError"
...
#define ROMP_HASH_COMBINER ROMP_UTIL_NAMESPACE "::hash_combine"
#define ROMP_MAKE_HASH_COMBINER(_h,_v) ROMP_HASH_COMBINER "(" << (_h) << ", " << (_v) << ")"
...
#define ROMP_MAKE_MODEL_ERROR_TYPE(_n,_msg) ROMP_MODEL_ERROR_TYPE_TYPE "(" << (_msg) << "," << ROMP_MAKE_LOCATION_STRUCT((_n).loc) << ")"
...
// #define _ROMP_CHOOSE_HANDLER _ROMP_PROPERTY_HANDLER_BASE "choose_handler"
#define _ROMP_PUT_HANDLER _ROMP_PROPERTY_HANDLER_BASE "put_handler"
